...
The gate complexity of the whole process is $\mathcal{O}(ITimes\times\alpha j_0poly(\log(4N))/\epsilon)$.
...
\end{align}
\begin{figure}[htbp]
	\subfigure[Reflection operator $G$]{\includegraphics[width=0.20\textwidth]{Fig/G.png}}
	\subfigure[$W$ operator]{\includegraphics[width=0.45\textwidth]{Fig/WW.png}}
	\caption{Quantum circuit of operator $G$ and $W$}
	\label{W}
\end{figure}
